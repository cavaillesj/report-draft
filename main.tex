...
\paragraph{}
We can remark that we have a bi stable system. With the origin for the first stable point. Another remark, the fraction $\frac{m}{d}$ is the ratio of dead wood over alive wood, when the fire is not present.
