...
\newpage
\paragraph{}
Also, when $AB$ is lower, we have again the same three sub-cases than for the "accumulation" case. We can observe that for this example, the dynamics do not change much.%, and that the extrapolation could make sense (but only if $AB$ is low enough).
